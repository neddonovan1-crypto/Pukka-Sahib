/* Build: assemble the shipped single-file index.html from src/.
   ...
   comments stripped. Run: node build.js */
"use strict";
var fs = require("fs");
...
function build() {
  ...
  // Multi-file dist for the hosted deploys, which may fetch external files.
  // Code split from markup so a content change doesn't bust the code bundle;
  // art lives as real files under assets/ rather than data URIs.
